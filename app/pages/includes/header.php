  ...
  <header class="p-3 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="http://localhost/public/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
           
          <img class="bi me-2" src="<?=ROOT?>/assets/images/logo.png"  width="80" height="80" style="object-fit:cover;">
        </a>

        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="<?=ROOT?>" class="nav-link px-2 <?=$url[0] =='home' ? 'link-primary':'link-dark'?>">Home</a></li>
          <li><a href="<?=ROOT?>/blog" class="nav-link px-2  <?=$url[0] =='blog' ? 'link-primary':'link-dark'?>">Data Visualization</a></li>
          <li><a href="<?=ROOT?>/Prediction" class="nav-link px-2  <?=$url[0] =='Prediction' ? 'link-primary':'link-dark'?>">Prediction</a></li>
          <li><a href="<?=ROOT?>/search" class="nav-link px-2  <?=$url[0] =='search' ? 'link-primary':'link-dark'?>">Search</a></li>
          <li><a href="http://localhost/practice/index.php" class="nav-link px-2  <?=$url[0] =='contact' ? 'link-primary':'link-dark'?>">Complain</a></li>
          <li><a href="http://localhost/detection/index.php" class="nav-link px-2  <?=$url[0] =='contact' ? 'link-primary':'link-dark'?>">Detection</a></li>
          <li><a href=" <?=ROOT?>/game" class="nav-link px-2  <?=$url[0] =='contact' ? 'link-primary':'link-dark'?>">Play Game</a></li>
          <li>
